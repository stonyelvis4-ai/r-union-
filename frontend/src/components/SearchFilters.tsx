      ...
      <div className="grid grid-cols-2 gap-3 sm:flex sm:flex-wrap sm:items-end">
        <div className="col-span-2 sm:col-auto">
          ...
          <input
            ...
            className="mt-1 w-full rounded-xl border border-gray-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-950/70 px-3 py-3 text-base text-gray-800 dark:text-slate-100 placeholder:text-gray-400 dark:placeholder:text-slate-500 outline-none ring-blue-500/0 transition focus:border-blue-400 focus:ring-2 focus:ring-blue-400/40 sm:w-64 sm:py-2 sm:text-sm"
          />
        </div>
        <div>
          ...
          <input
            ...
            className="mt-1 w-full rounded-xl border border-gray-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-950/70 px-3 py-3 text-base text-gray-800 dark:text-slate-100 outline-none ring-blue-500/0 transition focus:border-blue-400 focus:ring-2 focus:ring-blue-400/40 sm:w-auto sm:py-2 sm:text-sm"
          />
        </div>
        <div>
        ...
        <label className="col-span-2 flex min-h-11 items-center gap-2 text-gray-800 dark:text-slate-100 sm:col-auto">
          <input
            type="checkbox"
        ...
        <button
          ...
          onClick={onSearch}
          disabled={loading}
          className="col-span-2 min-h-11 rounded-xl bg-blue-500 px-4 py-3 text-sm font-semibold text-slate-950 shadow-md shadow-blue-500/40 hover:bg-blue-400 disabled:opacity-50 sm:col-auto sm:rounded-full sm:py-2"
        >
